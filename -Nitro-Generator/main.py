...
class Console():        
    def ui(self):
        os.system(f'cls && title Discord Nitro Generator  ^|  For Help join discord.gg/mDPkXJHe' if os.name == "nt" else "clear")
        print(center(f"""\n\n
 
            ~ Discord Nitro Generator ~
     
     github.com/DollarBey ~ Developed by DollarBey and '$
            For Help join discord.gg/mDPkXJHe \n\n
